...
import org.prom5.framework.models.erlangnet.ErlangNetPlaceType;
import org.prom5.framework.models.erlangnet.inscription.RouteInscription;
import org.prom5.framework.models.erlangnet.statement.AssignmentStatement;
import org.prom5.framework.models.erlangnet.statement.NoOperationStatement;
import org.prom5.framework.models.erlangnet.statement.ReceiveSenderAndValueStatement;
...
public class ErlangNet2ErlangWorkflowNetConverter {
	...
	private Function translate(String name, Statement statement) {
		if (statement instanceof AssignmentStatement) {
			...
			return new Function(
					name,
					new org.prom5.framework.models.erlang.AssignmentStatement(
			...
			return new Function(
					name,
					new org.prom5.framework.models.erlang.NoOperationStatement(
							nos.envId));
