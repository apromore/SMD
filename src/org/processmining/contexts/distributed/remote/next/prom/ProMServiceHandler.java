...
public class ProMServiceHandler implements ServiceHandler {
	...
	public void handleRequest(DataInputStream in, DataOutputStream out) {
								...
								if (exists) {
									...
									if (exists) {
										...
										try {
											...
											System.out.println("error executing the Plugin");
											e.printStackTrace();
											TransferHelpFunctions.writeLine(out, ProMProtocol.SERVER_ERROR);
										}
									} else {
	...
	protected void discardObject(DataOutputStream out, ProvidedObjectID o) {
		// TODO Auto-generated method stub
		TransferHelpFunctions.writeLine(out, ProMProtocol.SERVER_REQUEST_RECEIVED);
	 ...
	 * @throws IOException
	 */
	protected ProvidedObjectID receiveObject(DataInputStream in) throws IOException {
	...
	protected ProvidedObjectID receiveLog(DataInputStream in) throws Exception {
	 ...
	 * @throws Exception
	 */
	protected ProvidedObjectID receiveRemoteObject(DataInputStream in) throws Exception {
	 ...
	 * @throws Exception
	 */
	protected void sendObject(DataOutputStream out, ProvidedObjectID o2) throws Exception {
