...
public class TFrom {
    ...
    @XmlElementRefs({
        @XmlElementRef(name = "query", namespace = "pnml.apromore.org", type = JAXBElement.class),
        @XmlElementRef(name = "literal", namespace = "pnml.apromore.org", type = JAXBElement.class),
        @XmlElementRef(name = "documentation", namespace = "pnml.apromore.org", type = JAXBElement.class)
    })
    @XmlMixed
