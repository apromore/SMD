...
public class GTEvaluatorUtil {
	
	private static final Logger logger = LoggerFactory.getLogger(GTEvaluatorUtil.class);
	...
	private static Map<String, GTNode> addedLogClusters = new HashMap<String, GTNode>();
	...
	public static void writeData(GTClusterer logClusterer, long totalTime) {
...
//					int events = l.getLogSummary().getModelElements().length;
	...
	private static String getLogFileName(GTNode c) {
		int numInstances = c.log.size();
		String name = "log_" + c.getGroupId() + "_" + c.getID() + "_" + numInstances + ".mxml";
		return name;
	}
	
	public static void addCluster(String processName, GTNode c) {
