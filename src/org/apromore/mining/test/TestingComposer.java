 ...
 */
@Service("TestingComposer")
@Transactional(propagation = Propagation.REQUIRED)
public class TestingComposer {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(TestingComposer.class);
    ...
    // original code
    @Autowired
    private ProcessAnalyzer standardizer;
