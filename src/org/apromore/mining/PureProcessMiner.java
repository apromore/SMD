...
public class PureProcessMiner {
	
	private final Logger logger = LoggerFactory.getLogger(PureProcessMiner.class);
	...
	public void mineCollection(Collection<String> logPaths) throws Exception {
		...
		String outFolder1 = "/home/cn/eps/bpm-demo-new1/bpm-demo/Apromore-Core/apromore-service/data/pm1/t1/pm1";
		serialize(outFolder1, allMinedModels);
	}
