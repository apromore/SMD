...
public class ClusteringSummary {
    ...
    public ClusteringSummary(Long numClusters, Integer minClusterSize, Integer maxClusterSize, Float minAvgFragSize, Float maxAvgFragSize, Double minBCR, Double maxBCR) {
    	if (numClusters != null) {
