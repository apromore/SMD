...
public class RetUI extends JPanel implements ActionListener {
    ...
    */
	...
	try {
		sim.openIndex("./models/bettermodelpairs/searchmodelindex");
		long starttime = System.currentTimeMillis();
		sim.results = sim.env.runAnnotatedQuery("Goods Issue Processing Packing Processing Delivery Processing Picking Goods receipt issue slip is printed Transfer order created automatically Transfer order created manually Inspection before goods issue is to be carried out Goods issue is posted Certificate has to be created for delivery item Delivery without reference is to be created Delivery is to be created Picking needs to be carried out Material has been picked Material withdrawal is to be posted Delivery is created Material is issued Delivery is relevant for shipment Shipping unit is created Shipping unit is to be created ",100);
		sim.results = sim.env.runAnnotatedQuery("Goods Issue Processing Delivery Processing Transportation Planning and Processing Monitoring of Legal Controls Inspect independent of goods issue  Material is removed from stock Delivery is to be created Inspection before goods issue is to be carried out Document blocked due to insufficent hedge Legal control data is processed Credit limit is not sufficient Goods issue blocked for export Inspection lot status allows a goods issue Delivery is relevant for billing Document blocked due to legal control Delivery is relevant for shipment Goods issue is posted Material withdrawal is to be posted Order generated and delivery opened ",100);
		sim.results = sim.env.runAnnotatedQuery("Backorder Processing Customer Outline Agreement Shipping Costing Warehouse Management Shipment Sales Order Risk Credit Management Billing Product costng to material in sales document to be created Delivery is to be created Quotation reason occurred Contract is created Purchase requisition without source of supply created Subsequent Document is to be Created from Sales Activity Material is issued Missing parts situation could not be eliminated Unit costing for material in sales document to be created Delivery is relevant for shipment Missing parts situation is eliminated Order is created Document blocked due to legal control Bil doc is released for billing Document Blocked due to Insufficient Payment Guarantee Terms of credit have changed Items are cancelled Group Master Contract is to be Created Quotation to be created from inquiry Scheduling agreement release is issued Sales document preliminary costed via unit costing Deliveries need to be planned Sales requirements are created Missing parts information is generated Transfer order created automatically Invoice list is created Items are cancelled Goods movement is posted Shipment costs per item are calculated Transfer order item is confirmed Goods issue is posted Sales requirements are created Sales order preliminary costing via product costing Backorder processing is to be carried out for material Transfer order created manually Contract ist to be created Change to terms of credit refused Standard order is received Scheduling agreement is created Customer release order received Sched agreement must be created ",100);
		sim.results = sim.env.runAnnotatedQuery("Packing Processing Delivery Processing Picking Delivery without reference is to be created Delivery is to be created Picking needs to be carried out Material withdrawal is to be posted Shipping unit is created Shipping unit is to be created ",100);
		sim.results = sim.env.runAnnotatedQuery("Shipping Sales Order Billing Delivery is to be created Bil doc is released for billing Invoice list is created Goods issue is posted Standard order is received ",100);
		sim.results = sim.env.runAnnotatedQuery("Carry out invoicing arrangement Retrieve invoices Release Invoice Effectuate payment agreement Verify invoice Invoice verified Service registered Service or goods receipt issued Payment agreement must be effectuated Invoice entered into system Goods registered Invoicing arrangement in effect Invoice copy sent Order registered Invoice to be settled Invoice put on hold ",100);
		sim.results = sim.env.runAnnotatedQuery("Goods release Selection Packing Material taken from inventory Transportation unit to be produced Material released Material selected Transportation unit produced ",100);
		sim.results = sim.env.runAnnotatedQuery("Goods Issue Processing Picking Packing Processing Material is removed from stock Shipping unit is to be created Material is issued Material has been picked Shipping unit is created ",100);
		sim.results = sim.env.runAnnotatedQuery("Evaluated Receipt Settlement ERS  Invoice Overview Invoice Release Invoicing Plan Settlement Invoice Processing with Reference Invoice posted Service is accepted Material is released Invoicing plans require settlement Invoice received Goods receipt posted Goods receipts to be settled automatically Invoice transmitted for vendor s records Purchase order created Payment must be effected Invoice parked ",100);
		sim.results = sim.env.runAnnotatedQuery("Transportation Planning and Processing Delivery is relevant for shipment Shipment is Complete Deliveries need to be planned ",100);
		long endtime = System.currentTimeMillis();
		System.out.println("Time taken on old dataset (ms): " + (endtime - starttime));
		
		sim.openIndex("./models/bettermodelpairs/searchmodelindex");
		starttime = System.currentTimeMillis();
		sim.results = sim.env.runAnnotatedQuery("Accepted customer order purchase order receival confirmed Sales order created Key market informed Delivery time confirmation prepared Sales order internally forwarded Create sales order Confirm purchase order receival Inform key market regarding delivery date Prepare delivery time confirmation Forward sales order internally ",100);
		sim.results = sim.env.runAnnotatedQuery("product range and positioning requested Special request non catalogue or special config Range amp product positioned STIP reviewed Quotation created planning updated Approved or disapproved request Discount request Quotation distributed Catalogue generated No order in Key Market Order in Key Market Interest from key market Catalogue distributed Put order in Planning file F  Discount approval Range amp product positioning Quotation creation STIP review Put order in Planning file M  Info on Prospect Quotation distribution Catalogue distribution Catalogue generation Request for discount  No discount request Key Market will contact and discuss customer wishes Info on prospect received Order in Key Market  planning updated ",100);
		sim.results = sim.env.runAnnotatedQuery("Request for delivery service parts or system internally communicated  Invoice sent System or service parts shipped Transport documents created Invoice created Receive request for delivery internal communication confirm shipment Preparation shipment Send invoice Request for delivery received Key market notified ",100);
		sim.results = sim.env.runAnnotatedQuery("offered to broker no interest No replacement by diamond select Replacement by diamond select Info entered in GTI portal Determine interest PMRS in system Check specifications of deal Offer to broker Tell KM no interest  Competitors product trade in process System replaced by diamond select  Enter info in GTI portal Determine Negotiate equipment value Determination interest in system needed Specifications checked Interest in system No interest in system Competitors product trade in process initiated Equipment value determined negotiated ",100);
		sim.results = sim.env.runAnnotatedQuery("confirmation and price indication needed All required info available  Not all info correct or available All required info is available E mail with trade in form sent ultrasound system not in catalogue ultrasound system is in catalogue Presented info is correct Ask key market to revise presented information Presented info correct  Offered ultrasound system in catalogue  Send confirmation of requested arrival price indication to key market Look up value conditions in catalogue Calculate indication equipment value of offered device Confirmation price indication sent to key market Value conditions known indication equipment value of offered device calculated ",100);
		sim.results = sim.env.runAnnotatedQuery("Trade in process initiated Send confirmation of requested arrival price indication to Key Market Enter deal information in Ultrasound excel sheet Confirmation of requested arrival price indication send to Key Market  Deal information entered in Ultrasound excel sheet registration of arrival RAR to determine equipment value Shipping ultrasound devices by key markets Ultrasound devices devices shipped by key markets arrival registered equipment value determined Fill ultrasound excel sheet with RAR report data Ultrasound excel sheet filled with RAR report data Request project number from F amp A Project number obtained Put in article number into Exact Have PO created New record created PO created ",100);
		sim.results = sim.env.runAnnotatedQuery("Transport required Transport requirements determined Stored transport information obtained Logistic provider arranged Workplan transport created Determination transport requirements Arrange logistic provider Create workplan transport ",100);
		sim.results = sim.env.runAnnotatedQuery("Customer order received System destination domestic System destination international Order acceptable Regulatory requirements reviewed Order not acceptable Customer file maintained Planning file updated Order summary reviewed Order summary generated Review regulatory requirements System destination Review order Update planning file Revise order Maintain customer file Review order summary Generate order summary Process customer order Customer order processed ",100);
		sim.results = sim.env.runAnnotatedQuery("Need for external supplier PO generated Available systems identified PM forwarded PM Approved PM not approved Procurement not authorized  Pricing negotiated Procurement authorized PM generated revised Purchase agreement authorized Purchase agreement submitted Send to supplier Identify available systems Supplier submits invoice Authorize procurement Submit to finance Invoice approval Generate PO Forward approved PM to buyer planner Submit purchase agreement Authorize purchase agreement  Generate revise PM Purchase authorization Negotiate pricing Invoice approved Invoice not approved invoice sent Sent to supplier Submitted to finance ",100);
		sim.results = sim.env.runAnnotatedQuery("Potential new product introduction opportunity Q amp R matrix s created Results reported Training requirements determined Document requirements determined Q amp R assessments performed Regulatory and safety requirements checked Machine requirements identified Create Q amp R matrix s Report results Determine training requirements Determine document requirements Perform Q amp R assessments Check regulatory safety requirements Determine machine requirements Initiate NPI assessments NPI assessments initiated ",100);
		endtime = System.currentTimeMillis();
		System.out.println("Time taken on new dataset (ms): " + (endtime - starttime));
		System.exit(0);
		/*
		sim.scored = sim.results.getResults();
		sim.titles = sim.env.documentMetadata(sim.scored, "docno" );
		for (String title: sim.titles){
