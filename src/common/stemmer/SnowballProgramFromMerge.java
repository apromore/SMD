...
public class SnowballProgramFromMerge {
	// stopwords
...
//	protected String mapdir = "lib/similarity/" ;
	protected String mapdir = "/home/cn/programs/merger/lib/similarity/" ;

	public void setMapDir(String mapDir) {
		mapdir = mapDir;
	}

	protected SnowballProgramFromMerge() {
	...
	protected void copy_from(SnowballProgramFromMerge other) {
