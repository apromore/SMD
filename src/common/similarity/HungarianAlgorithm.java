...
public class HungarianAlgorithm{
    ...
    public static int[][] computeAssignments(double[][] matrix) {
        ...
        while (!allAreCovered(coveredCols)) {
            ...
            // TODO: Chathura: loop count and check is introduced to prevent infinite looping.
            int loopCount = 0;
            while (primedZero == null) {
            	
            	loopCount++;
            	if (loopCount > 100000) {
            		logger.error("Terminating the possibly infinite loop after 100000 runs. Merge will be failed.");
            		throw new RuntimeException("Possibly infinite loop terminated.");
            	}
